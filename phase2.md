...
- این تصمیم به‌صورت آگاهانه و برای ساده‌سازی مدیریت شبکه اتخاذ شده است.
...
برای بررسی صحت عملکرد:
- تست بستن دسترسی SSH
- تست DNAT با سرویس واقعی
- تست MASQUERADE
- تست حذف قوانین
- تست ماندگاری قوانین پس از reboot
...
این فاز زیرساخت لازم برای توسعه قابلیت‌های پیشرفته‌تر در مراحل بعدی پروژه را ایجاد می‌کند.
